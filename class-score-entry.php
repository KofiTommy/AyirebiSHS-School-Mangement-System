...
$pageDescription = "Choose an assigned subject, enter continuous assessment marks faster, and keep the score sheet usable on both desktop and mobile.";
        ...
        $messages[] = score_entry_alert("warning", $invalidCount." selected student(s) were skipped because the mark was negative, above ".$scoreLimit.", or greater than the total score.");
            ...
            if($savedCount > 0 && isset($_SESSION['SYSTEMTYPE']) && $_SESSION['SYSTEMTYPE'] === "Teacher"){
                logSystemChange(
                    $con,
                    "SCORE_ENTRY_CLASS",
                    "Teacher entered class scores for ".$savedCount." student(s). Assignment: ".$assignmentId.", Total: ".$totalMark
                );
            }
    ...
    <section class="score-entry-hero">
        ...
        <aside class="score-entry-hero__aside">
            <div class="score-entry-tip-card">
                ...
                <h2>Designed for faster marking</h2>
                <ul>
    ...
    <div class="score-entry-layout">
        <section class="score-entry-panel">
            ...
            <div class="score-entry-empty-state">
                ...
                <p>Your assigned score sheets will appear here once classes, subjects, and year-based sessions have been linked to your account.</p>
            </div>
            <?php } ?>
        </section>
        ...
        <section class="score-entry-panel">
            ...
            <?php } else { ?>
                ...
                <div class="score-entry-empty-state">
                    <h3>All class scores are already entered</h3>
