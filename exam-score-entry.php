        ...
        <section class="score-entry-panel">
            ...
            <?php } else { ?>
                ...
                <form
                    ...
                    data-score-sheet
                    data-confirm-message="Please check these exam scores carefully before saving. Once the result is approved, you will not be able to change the scores unless the administrator reopens corrections. Do you want to save now?">
